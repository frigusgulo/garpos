...
def outresults(
    ...
    geocent = [
        float(cfg.get("Site-parameter", "Latitude0")),
    ...
    ###################
    if invtyp != 0:
        shots["dV0"] = av[0][0] / 2.0 + av[1][0] / 2.0
        shots["gradV1e"] = av[0][1] / 2.0 + av[1][1] / 2.0
        shots["gradV1n"] = av[0][2] / 2.0 + av[1][2] / 2.0
        shots["gradV2e"] = av[0][3] / 2.0 + av[1][3] / 2.0
        shots["gradV2n"] = av[0][4] / 2.0 + av[1][4] / 2.0
